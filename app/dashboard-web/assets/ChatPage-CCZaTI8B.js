    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          currentProject.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
            createVNode(VIcon, {
              color: "primary",
              class: "mr-2"
            }, {
            ...
            createBaseVNode("span", _hoisted_3, toDisplayString(currentProject.value.id), 1)
              ...
              return openBlock(), createElementBlock(Fragment, {
                ...
                item.kind === "user" ? (openBlock(), createElementBlock("div", _hoisted_7, [
                    ...
                    item.editing ? (openBlock(), createElementBlock("div", _hoisted_9, [
                      ...
                      createBaseVNode("div", _hoisted_10, [
                        createVNode(VBtn, {
                          ...
                          size: "x-small",
                          color: "medium-emphasis",
                          onClick: ($event) => item.editing = false,
                          title: "Cancel"
                        }, null, 8, ["onClick"]),
                        createVNode(VBtn, {
                          icon: "mdi-check",
                      ...
                      createBaseVNode("div", _hoisted_12, [
                        createBaseVNode("div", _hoisted_13, [
                          ...
                          !uiState.isRunning ? (openBlock(), createBlock(VBtn, {
                            ...
                            size: "x-small",
                            color: "medium-emphasis",
                            onClick: ($event) => confirmDeleteMsg(idx),
                            title: "Delete"
                          }, null, 8, ["onClick"])) : createCommentVNode("", true)
                        ])
                      ])
                  ...
                  createVNode(VCard, {
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", {
                        class: "d-flex align-center pa-3 tool-header",
                        onClick: ($event) => item.expanded = !item.expanded
                      }, [
                        createVNode(VIcon, {
                          color: item.toolType === "tool_start" ? "warning" : item.isError ? "error" : "success",
                          size: "18",
                          class: "mr-2"
                        }, {
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(item.toolType === "tool_start" ? "mdi-code-braces" : item.isError ? "mdi-alert-circle" : "mdi-check-circle"), 1)
                          ]),
                          _: 2
                        }, 1032, ["color"]),
                        ...
                        createVNode(VIcon, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(item.expanded ? "mdi-chevron-up" : "mdi-chevron-down"), 1)
                          ]),
                          _: 2
                        }, 1024)
                      ], 8, _hoisted_15),
