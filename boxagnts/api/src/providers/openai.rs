...
impl OpenAiProvider {
    ...
    pub fn to_openai_messages_pub(
        messages: &[boxagnts_core::types::Message],
    ...
    pub fn to_openai_tools_pub(tools: &[boxagnts_core::types::ToolDefinition]) -> Vec<Value> {
    ...
    pub fn parse_non_streaming_response_pub(
        json: &Value,
        provider_id: &boxagnts_core::provider_id::ProviderId,
    ...
    fn to_openai_tools(
        tools: &[boxagnts_core::types::ToolDefinition],
    ) -> Vec<Value> {
        tools
            .iter()
            .map(|td| {
