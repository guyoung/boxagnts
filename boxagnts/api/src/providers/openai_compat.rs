...
use boxagnts_core::types::{ContentBlock, UsageInfo};
use futures::Stream;
...
impl OpenAiCompatProvider {
    ...
    fn inject_reasoning_for_tool_turns(
        ...
        original_messages: &[boxagnts_core::types::Message],
        field: &str,
    ) {
        use boxagnts_core::types::{MessageContent, Role};
...
impl LlmProvider for OpenAiCompatProvider {
    ...
    {
        println!("openai_compat create_message_stream {} {}", self.id, self.name );
