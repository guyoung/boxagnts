...
use boxagnts_core::mcp_templates::TemplateRenderer;
...
impl McpManager {
    ...
    pub async fn auth_state(&self, server_name: &str) -> McpAuthState {
        ...
        if let Some(token) = oauth::get_mcp_token(server_name).await {
