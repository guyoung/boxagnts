/// https://github.com/spinframework/spin/blob/main/crates/outbound-networking-config/src/allowed_hosts.rs
use std::ops::Range;
use std::sync::Arc;
...
enum PartialAllowedHostConfig {
    ...
    Unresolved(super::super::expressions::Template),
}
...
impl PartialAllowedHostConfig {
    ...
    fn resolve(
        self,
        resolver: &super::super::expressions::PreparedResolver,
    ...
    fn validate(&self, resolver: &super::super::expressions::Resolver) -> anyhow::Result<()> {
...
impl AllowedHostsConfig {
    ...
    pub fn validate<S: AsRef<str>>(hosts: &[S], resolver: &super::super::expressions::Resolver) -> anyhow::Result<()> {
    ...
    fn parse_partial<S: AsRef<str>>(hosts: &[S]) -> anyhow::Result<Vec<PartialAllowedHostConfig>> {
        ...
        for host in hosts {
            let template = super::super::expressions::Template::new(host.as_ref())?;
...
mod test {
    ...
    fn dummy_resolver() -> super::super::super::expressions::PreparedResolver {
        super::super::super::expressions::PreparedResolver::default()
    }
