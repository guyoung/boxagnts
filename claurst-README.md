...
```bash
# Start Claurst
claurst-20260508-b8a3f80

# Or run a one-shot headless query
claurst-20260508-b8a3f80 -p "explain this codebase"
```
...
cd claurst-20260508-b8a3f80/src-rust
cargo build --release --package claurst-20260508-b8a3f80

# Binary is at target/release/claurst-20260508-b8a3f80
```
